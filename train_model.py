...
data = pd.read_csv(r"C:\Users\garvi\OneDrive\Documents\Code\Real-Time Stress and Emotion Detection System\features.csv", header=None) #Used to load the CSV file
